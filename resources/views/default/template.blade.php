        ...
        <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    <li class="active"><a href="<?php echo route('home'); ?>">Home</a>
                    </li>
                    <li><a href="<?php echo route('about'); ?>">About</a></li>
                    <li><a href="<?php echo route('articles'); ?>">Articles</a>
                    </li>
                    <li>
            ...
            <div class="col-md-9">
                ...
                <div class="col-md-6">
                    ...
                    <p>Donec id elit non mi porta gravida at eget metus. Fusce
                        ...
                        porta
                        sem malesuada magna mollis euismod. Donec sed odio
                        dui. </p>
                ...
                <div class="blog-post">
                    ...
                    <p>Cum sociis natoque penatibus et magnis <a href="#">dis
                            parturient montes</a>, nascetur ridiculus mus.
                        Aenean eu
                    ...
                    <blockquote>
                        <p>Curabitur blandit tempus porttitor. <strong>Nullam
                                quis
                                risus eget urna mollis</strong> ornare vel eu
                            leo.
